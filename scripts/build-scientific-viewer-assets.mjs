...
async function main() {
  ...
  const manifest = {
    ...
    dataset: {
      ...
      description:
        "Three cropped cortical-layer surfaces and three proofread cell surfaces sharing one coordinate system. Colors are interface encodings, not medical classifications.",
