...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  const demoIntro = isRedEye
    ...
    : isCompactCreative
      ...
      : isNeuralVisualizer
        ? "Compare two original full-resolution public source GLBs with a packed meshopt LOD 0 bootstrap across a mixed H01 scene—three cortical-layer context surfaces and seven proofread cells—then inspect demand-driven LOD, cache, material, and camera behavior. The public data is unrelated to the professional engagement."
